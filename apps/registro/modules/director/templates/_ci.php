<script>
    function verificarCedula()
    {
        ...
        if(error==null) {
            ...
            $.ajax({
                url:'<?php echo sfConfig::get('sf_app_registro_url'); ?>director/BuscarDirector',
                type:'POST',
                dataType:'json',
                data:'cedula_verificar='+$("#personas_persona_ci").val()+'&registro_disciplina_id='+$('#pae_registro_disciplina_id').val(),
                success:function(json){
                    $('#div_espera_verificar_cedula').html('');
                    if(json['status']=='ok') {
                        $('#personas_persona_primer_nombre').val(json['content']['primer_nombre']);
                        $('#personas_persona_primer_apellido').val(json['content']['primer_apellido']);
                        
                        $('#personas_persona_f_nacimiento_day').val(json['content']['f_nacimiento_day']);
                        $('#personas_persona_f_nacimiento_month').val(json['content']['f_nacimiento_month']);
                        $('#personas_persona_f_nacimiento_year').val(json['content']['f_nacimiento_year']);
                        
                        $('#personas_persona_f_nacimiento_jquery_control').val(json['content']['f_nacimiento']);
...
<div class="sf_admin_form_row sf_admin_text sf_admin_form_field_ci">
    <div>
        ...
        <div class="content" style="position: relative;">
            ...
            <input type="hidden" id="pae_registro_disciplina_id" value="<?php echo sfContext::getInstance()->getUser()->getAttribute('pae_registro_disciplina_id') ?>">
