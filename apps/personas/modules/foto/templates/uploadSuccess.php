...
<div align="center">
        ...
        <div align="left">
        <form name="thumbnail" action="<?php echo sfConfig::get('sf_app_personas_url'); ?>foto/thumbnail" method="post">
                ...
                <input type="submit" name="upload_thumbnail" value="Guardar Ajustes" id="save_thumb" />
        </form>
        </div>
